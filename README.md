...
Точный трекинг: Использует мощную модель YOLO11 от Ultralytics и алгоритм ByteTrack, присваивающий уникальные ID каждому объекту.  

Гибкие источники: Поддержка веб-камер и видеофайлов популярных форматов (mp4, avi, mov и др.).  

Аналитика в реальном времени: Панель метрик с подсчетом объектов в кадре и общим числом уникальных объектов за сессию.  
